                        ...
                        <div className="col-span-12 md:col-span-6">
                            ...
                            </h2>
                            {
                                paymentCard.map((item, index) => {
                                    return (
                                        <div key={index} className=' cursor-pointer border border-customGray rounded-[6px] my-4 px-5 py-3 flex justify-between items-center md:w-[420px] '>
                                            <div className='flex items-center'>
                                                <img src={item.image} alt='' className='w-[60px] h-[30px] inline-block object-contain align-text-top ' />
                                                <p className='text-[15px] font-normal text-customDarkGray capitalize mx-4'>
                                                    {item.text}
                                                </p>
                                            </div>
                                            <img src={item.arrow} alt='' className='w-[20px] h-[20px] inline-block object-contain ' />
                                        </div>
                                    )
                                })
                            }
                ...
                <div className="bg-white rounded-lg shadow-lg w-11/12 sm:w-1/2 md:w-[500px] max-h-[90vh] overflow-y-auto">
                    <div className="p-4 relative">
                        <div className="absolute right-3 top-4">
                            <img src={image.crossBlue} alt="" className="w-[15px] h-auto cursor-pointer"
                                onClick={closeModal} />
                        </div>

                        <div className='text-center'>
                            <img src={image.success} alt='' className='w-[70px] h-auto inline-block object-contain ' />
                            ...
                            <img src={image.dashed} alt='' className='w-full h-auto inline-block object-contain px-7' />
                            <div className='px-7'>
                                <button
                                    onClick={handleClick}
