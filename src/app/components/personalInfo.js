...
const PersonalInfo = ({ profileImage, handleImageUpload, setProfileImage,inputProfile }) => {
    return (
      <>
        <h2 className="text-2xl text-customBlue font-semibold mb-4">Personal Information</h2>
        <div className="flex flex-col items-center">
            ...
            <div className="flex justify-center mb-3">
              <div className="w-24 h-24 bg-customGray rounded-full relative">
                ...
                <span className="absolute bottom-0 right-0 bg-white rounded-full w-[28px] h-[28px] p-[5px]">
                  <label htmlFor="profileImage" className="cursor-pointer w-[17px] h-full inline-block">
                    <img src="/camera.svg" alt="Camera" className="w-full h-full object-contain" />
                  </label>
                </span>
                <input
                  id="profileImage"
          ...
          <form className="w-full space-y-6">
            ...
            <div className='!mt-5'>
              <label htmlFor='' className='text-[17px] font-medium text-customBlue'>
                Bio
              </label>
              <textarea
