          ...
          <div className="md:flex sm:flex items-center space-x-2 p-2 mt-1 ">
            <div className="relative flex items-center flex-1 py-1 rounded-[6px] border-2 border-customGray">
              <Link href="#" className="w-[100%] rounded-[6px]">
                <input
                  type="text"
                  placeholder="Start typing a trader’s name"
                  className=" pr-4 py-2 text-customGray border-none focus:outline-none active:outline-none w-[100%] rounded-[10px] "
                />
              </Link>
              ...
              {users.map((user, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <Image
                    ...
                    src={user.avatar}
                    alt="img"
                    className="w-[40px] h-[40px] inline-block object-contain "
                  />
                  <div className="flex-1">
                    <p className="font-semibold text-customBlue ">
                      {user.name}
                    </p>
                    <h3 className="font-sans">{user.time}</h3>
          ...
          <div className="md:w-3/4 flex flex-col">
            ...
            <div className="bg-white p-4 border-t-customLightBorder flex items-center">
              ...
              <Image
                ...
                src={image.sender}
                alt="img"
                className="inline-block mx-2 w-[50px] h-[50px] object-contain "
              />
            </div>
          </div>
        </div>
