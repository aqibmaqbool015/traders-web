...
export const inputField = [
  {
    ...
    labelClass: "text-[17px] text-customDarkGray font-medium",
  },
  {
    label: "Feedback",
    type: "text",
...
export const bidButton = [
  {
    ...
    name: "amount",
    class:
      " flex justify-center py-2.5 px-6 border border-customBlue rounded-[25px] md:min-w-[120px] shadow-sm text-sm font-medium text-customBlue bg-transparent !mt-2 mx-3 ",
  },
  {
    image: "/tick.svg",
    class:
      " flex justify-center py-2.5 px-6 border border-transparent rounded-[25px] md:min-w-[120px] shadow-sm text-sm font-medium text-white bg-customBlue !mt-2 mx-3",
  },
  {
    image: "/cross-custom.svg",
    class:
      " flex justify-center py-2.5 px-6 border border-customBlue rounded-[25px] md:min-w-[120px] shadow-sm text-sm font-medium text-customBlue bg-transparent !mt-2 mx-3",
  },
];
...
export const inputProfile = [
  {
    ...
    name: "fName",
    placeholder: "Tim",
    labelClass: "text-[17px] font-medium text-customBlue",
  },
  {
    label: "Last Name",
    type: "text",
...
export const userLeader = [
  {
    name: "Jonathan",
    lastMessage: "4.9 (32 reviews)",
    star: "/star-fill.svg",
