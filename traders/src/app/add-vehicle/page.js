                ...
                <div className="w-full flex flex-col items-center">
                    ...
                    <div className="max-w-md w-full px-4 md:px-0">
                        <div className="min-h-screen flex flex-col items-center p-4">
                            <h1 className="text-2xl font-semibold mb-4 text-center text-[26px]
                    text-customBlue">
                                Add Vehicle
                            </h1>
                                            ...
                                            {frontImage ? (
                                                ...
                                                <div className="text-center">
                                                    <label className="inline-block cursor-pointer">
                                                        <img src={image.car} alt='' className='w-[70px] h-auto inline-block object-contain mb-1' />
                                                    ...
                                                    <p className="text-customDarkGray">
                                                        ...
                                                        Suspendisse nec justo elit. Maecenas euismod
                                    ...
                                    <div className="shadow-custom rounded-lg text-center bg-transparent h-[200px] grid place-items-center">
                                        <div>
                                            {backImage ? (
                                                ...
                                                <div>
                                                    <label className=" inline-block cursor-pointer">
                                                        <img src={image.carVendor} alt='' className='w-[70px] h-auto inline-block object-contain mb-1' />
                                                        <p className='text-[18px] text-customBlue font-semibold capitalize'>
